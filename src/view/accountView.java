	...
	public void actionPerformed(ActionEvent e) {
		...
		*/
		...
		if(btnTitle.equals("id")) {
			...
			if(b) {	// 아이디 있는 경우
				JOptionPane.showMessageDialog(null, "id 사용불가능");
				idTextF.setText("");
			}
			else { // 아이디 없는 경우
				JOptionPane.showMessageDialog(null, "사용할 수 있는 id 입니다.");
			}
		...
		// 회원가입 버튼 눌렀을 때
			...
			// memberController에 있는 regiAfter함수 실행
			s.memCtrl.regiAfter(idTextF.getText(), passTextF.getText(),
